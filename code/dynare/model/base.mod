...
gam_xgap=  @{GAM_XGAP} ;     // Taylor rule feedback on output gap
gam_pi  =  @{GAM_PI}   ;     // Taylor rule feedback on expected inflation
...
sig_con =  @{SIG_CON} ;      // Std of consumption taste shock
sig_gov =  @{SIG_GOV} ;      // Std of government spending shock

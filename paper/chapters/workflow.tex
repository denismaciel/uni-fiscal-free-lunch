...
\par
\bigskip
Although the git system is primarily designed to be used from the command line (Terminal for macOS or Command Line for Windows), GitHub offers a very user-friendly desktop application, which makes possible for not-so-advanced user to profit from its features. GitHub is free as long as you are willing to make your project public. The current source code, reproducible build configuration, generated figure pipeline and Python implementation for this project are available online.\footnote{\url{https://github.com/denismaciel/uni-fiscal-free-lunch}}
